defmodule JidoChatUIWeb.UserAuth do
  ...
  @remember_me_cookie "_jido_chat_ui_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      JidoChatUIWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  @doc """
  Mounts the current user scope into LiveViews.
  """
  ...
  defp mount_current_scope(socket, session) do
    Phoenix.Component.assign(socket, :current_scope, current_scope_from_session(session))
  end
